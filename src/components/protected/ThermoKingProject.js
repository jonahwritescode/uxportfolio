        ...
        <div className="bg-black pt-20">
            <section className="px-4 md:px-0 max-w-4xl mx-auto py-6">
                    <div className="flex flex-col space-y-2">
                        ...
                        <p className="text-gray-400 text-lg pt-1 pb-4">3 min read&nbsp;&nbsp;//&nbsp;&nbsp;January 2021 - June 2021</p>  
                    </div>           
            </section>
            ...
            <section className="bg-white py-4">
                <div className="max-w-4xl mx-auto px-4 md:px-0">
                    ...
                    <p className="text-black md:text-lg mb-8">In early 2021, there were a ton of Thermo King mobile apps (11 in Apple's App Store at the time). In this project, I worked to improve the mobile experience for our customers by consolidating the most used features into a single app.
                    </p>
                    ...
                    <p className="text-gray-500 mx-auto pt-2 pb-4 max-w-3xl text-center text-sm md:text-base">I was inspired by how the E*TRADE app presents complex data.</p>
...
<br></br><br></br>I also wanted to make better use of space. Because of how the information was arranged in the existing design, only display three data points could be displayed for each vehicle. The new design has no such limitation. Users can view any number of data points by scrolling horizontally.              
                    </p>
...
<br></br><br></br>Since this was such a widely requested feature, I wanted to ensure it was easy to find. The title of the Vehicle List page became the name of the currently selected fleet. Dealers could change the fleet by tapping on the title. I added a chevron for tap affordance.             
                    ...
                    <p className="text-black md:text-lg pb-8">Thermo King Connect launched several months after I left the company to join Truist. For that reason, I'm uncertain about the business outcomes or financial performance of the app. From what I can gather, feedback has been mixed. The app currently holds a 3.4 rating on the app store - with low reviews citing bluetooth issues and missing vehicles.       
                    </p>
                </div>
            </section>
